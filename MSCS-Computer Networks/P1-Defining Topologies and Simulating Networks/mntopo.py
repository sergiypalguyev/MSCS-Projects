...
class MNTopo(Topo):
    ...
    def __init__(self, cpu=.1, max_queue_size=None, **params):
        ...
        hostConfig = {'cpu': cpu}
        # Adjusted for 10ms delay and 50 Mbps bandwidth
        ...
        s2 = self.addSwitch('s2') # Switch 2
        s3 = self.addSwitch('s3') # Switch 3
