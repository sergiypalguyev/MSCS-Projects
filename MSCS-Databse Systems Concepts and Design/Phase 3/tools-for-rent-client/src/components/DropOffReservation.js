...
export default  class DropOffReservation extends React.Component {
  ...
  pushToConfirm = function(){
    ...
    this.props.history.push('/dropoffconfirm');
  }
  ...
  handleClick(e, rId) {
    ...
    axios.get('http://localhost:8080/reservation/dropoff?reservationID=' + rId)
      .then(res => {
        console.log(res);
        var newModalData = {
          modalIsOpen: true,
  ...
  render() {
    if (this.state.firstTimeLoad == true){
      axios.get('http://localhost:8080/reservation/dropoff')
        .then(res => {
          ...
          <TableHeader
              ...
              >
                 ...
                 <TableBody
                   ...
                   <br></br><br></br>
                   <button onClick= {(e) => this.pushToConfirm(e)} >Drop Off </button>
