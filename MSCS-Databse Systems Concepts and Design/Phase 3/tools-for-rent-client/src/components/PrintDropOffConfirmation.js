...
export default  class PrintDropOffConfirmation extends React.Component {
  ...
  dropOff = (e) => {
        ...
        // sending the drop off to the DB
        var dropOffURL = "http://localhost:8080/reservation/dropoff?reservationID=" + this.state.selectedResId + "&clerkID=" + localStorage.getItem("userId");
        axios.get(dropOffURL)
          .then(res => {
  ...
  render() {
    if (this.state.firstTimeLoad == true){
      axios.get('http://localhost:8080/reservation/dropoff?reservationID=' + localStorage.getItem("selectedResId"))
        .then(res => {
          ...
          var due = Number(parseInt(res['data']['totalRentalPrice']) - parseInt(res['data']['totalDepositPrice']));
          console.log("what is due");
          console.log(due);
          this.setState({totalDuePrice : due});
    ...
    return (
      <div>
          ...
          <div class="viewprofile">
            ...
            <br></br><br></br>
            Reservation ID: # {localStorage.getItem("selectedResId")}
            <br></br><br></br>
            ...
            <br></br><br></br><b>Total Due: </b>
            ${parseFloat(this.state.totalDuePrice).toFixed(2)}
                ...
                >
                 ...
                 <TableBody
                  ...
                  {this.state.tools.map( (res) => (
                   ...
                   <br></br><br></br>
                   <RaisedButton label="Drop Off" primary={true}  onClick= {(e) => this.dropOff(e)} />
                   <br></br><br></br><RaisedButton disabled={this.state.readyToPrint} label="Print Contract" primary={true} onClick= {(e) => this.onSubmit(e)} />
                   <br></br><br></br>
