...
class TestAllTrafficSignsScene(unittest.TestCase):
    """Test Traffic Sign Detection using a simulated street scene"""
    ...
    def test_stop_sign(self):
        ...
        cv2.imshow('All_signs', test_image)
        cv2.waitKey(0);
        check_result(image_name, coords, (349,348), 5)
    ...
    def test_construction_sign(self):
        ...
        cv2.imshow('All_signs', test_image)
        cv2.waitKey(0);
        check_result("construction_150_200_blank", coords, (646,353), 5)
...
class TestAllTrafficSignsScene(unittest.TestCase):
    ...
    def test_stop_sign(self):
        image_name = "scene_some_signs.png"
        test_image = cv2.imread("input_images/test_images/" + image_name)
        coords = ps2.stop_sign_detection(test_image)

        cv2.circle(test_image,coords, 5, (0,255,0), 2)
        cv2.imshow('Some_signs', test_image)
        cv2.waitKey(0); 
    
        check_result(image_name, coords, (548,148), 5)
    ...
    def test_warning_sign(self):
        ...
        check_result(image_name, coords, (299,349), 5)
    ...
    def test_do_not_enter_sign(self):
        ...
        check_result(image_name, coords, (636,436), 5)
