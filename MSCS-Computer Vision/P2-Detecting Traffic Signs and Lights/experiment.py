...
def draw_tl_center(image_in, center, state):
    ...
    cv2.putText(image,("((" + str(center[0]) + "," + str(center[1]) + "), '" + state + "')"), (center[0]-50,center[1]-50), cv2.FONT_HERSHEY_SIMPLEX, 0.7,(0,0,0),6)
    cv2.putText(image,("((" + str(center[0]) + "," + str(center[1]) + "), '" + state + "')"), (center[0]-50,center[1]-50), cv2.FONT_HERSHEY_SIMPLEX, 0.7,(255,255,255),2)
...
def mark_traffic_signs(image_in, signs_dict):
    ...
    for key, value in signs_dict.iteritems():
        print key, value
        cv2.circle(image, value, 5, (0,255,0), 2)
        cv2.putText(image,("(" + str(value[0]) + "," + str(value[1]) + ")"), (value[0]-50,value[1]-50), cv2.FONT_HERSHEY_SIMPLEX, 0.6,(0,0,0),6)
        cv2.putText(image,("(" + str(value[0]) + "," + str(value[1]) + ")"), (value[0]-50,value[1]-50), cv2.FONT_HERSHEY_SIMPLEX, 0.6,(255,255,255),2)
        
        cv2.putText(image,("(" + key + ")"), (value[0]-50,value[1]-70), cv2.FONT_HERSHEY_SIMPLEX, 0.6,(0,0,0),6)
        cv2.putText(image,("(" + key + ")"), (value[0]-50,value[1]-70), cv2.FONT_HERSHEY_SIMPLEX, 0.6,(255,255,255),2)
...
def part_3():
    ...
    print "-----Part 3 Some Signs and All Signs"
