...
function ajax_overlayBar_chart(chart, url, data) {
    ...
    $.getJSON(url, data).done(function(response) {
        chart.data.datasets[0].data = response.data.min;  // or you can iterate for multiple datasets
        chart.data.datasets[1].data = response.data.max; // or you can iterate for multiple datasets
